...
import controller.PanelKHController;

/**
 *
 * @author KIM THOA
 */
public class JPanelKH extends javax.swing.JPanel {
    ...
    public JPanelKH() {
        initComponents();
        PanelKHController controller =new PanelKHController(jPaneltable, jbtthemsach, jtftimkiem, jbtlammoi);
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(982, 433));

        jbtthemsach.setFont(new java.awt.Font("Segoe UI Black", 0, 12)); // NOI18N
        jbtthemsach.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/add.png"))); // NOI18N
        jbtthemsach.setText("Thêm độc giả");
